...
class Profile:
    ...
    def get_profile_by_name(self, profile_name: str):
        """Get profile by name"""
        profile_file = read_json(self._info.profiles)
    ...
    def get_default_param_by_name(self, param_name: str):
        ...
        default_params_file = read_json(self._info.default_params)
    ...
    def get_client_by_name(self, client_name: str):
        """Get client by name"""
        clients_file = read_json(self._info.clients)
    ...
    def get_provider_by_name(self, provider_name: str):
        ...
        providers_file = read_json(self._info.providers)
    ...
    def get_recipient_by_name(self, recipient_name: str):
        ...
        recipients_file = read_json(self._info.recipients)
